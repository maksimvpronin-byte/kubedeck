...
```text
apps\desktop\release\KubeDeck-Portable-2.5.1-x64.exe
```
...
```text
apps/desktop/release/KubeDeck-2.5.1-arm64.dmg
apps/desktop/release/KubeDeck-2.5.1-arm64.zip
```
...
- [Release notes 2.5.1](./RELEASE_NOTES_2.5.1.md)
- [Regression checklist 2.5.1](./REGRESSION_CHECKLIST_2.5.1.md)
