...
```text
apps\desktop\release\KubeDeck-Portable-2.7.5-x64.exe
```
...
```text
apps/desktop/release/KubeDeck-2.7.5-arm64.dmg
apps/desktop/release/KubeDeck-2.7.5-arm64.zip
```
...
- [Release notes 2.7.5](./docs/releases/RELEASE_NOTES_2.7.5.md)
- [Regression checklist 2.7.5](./docs/releases/REGRESSION_CHECKLIST_2.7.5.md)
