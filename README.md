...
```text
apps\desktop\release\KubeDeck-Portable-2.4.5-x64.exe
```
...
```text
apps/desktop/release/KubeDeck-2.4.5-arm64.dmg
apps/desktop/release/KubeDeck-2.4.5-arm64.zip
```
...
- [Release notes 2.4.5](./RELEASE_NOTES_2.4.5.md)
- [Regression checklist 2.4.5](./REGRESSION_CHECKLIST_2.4.5.md)
