...
```text
apps\desktop\release\KubeDeck-Portable-2.7.4-x64.exe
```
...
```text
apps/desktop/release/KubeDeck-2.7.4-arm64.dmg
apps/desktop/release/KubeDeck-2.7.4-arm64.zip
```
...
- [Release notes 2.7.4](./docs/releases/RELEASE_NOTES_2.7.4.md)
- [Regression checklist 2.7.4](./docs/releases/REGRESSION_CHECKLIST_2.7.4.md)
