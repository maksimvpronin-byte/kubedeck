...
```text
apps\desktop\release\KubeDeck-Portable-2.8.1-x64.exe
```
...
```text
apps/desktop/release/KubeDeck-2.8.1-arm64.dmg
apps/desktop/release/KubeDeck-2.8.1-arm64.zip
```
...
- [Release notes 2.8.1](./docs/releases/RELEASE_NOTES_2.8.1.md)
- [Regression checklist 2.8.1](./docs/releases/REGRESSION_CHECKLIST_2.8.1.md)
