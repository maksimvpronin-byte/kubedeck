...
> Архив исходного технического задания для Python/FastAPI-архитектуры. Документ сохраняется как история требований, но не является source of truth для KubeDeck 2.x. Актуальная архитектура описана в `docs/architecture.md`.
