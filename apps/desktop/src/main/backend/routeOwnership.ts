...
export const ROUTE_OWNERSHIP: readonly RouteOwnership[] = [
  ...
  { method: "GET", path: "/clusters/{cluster_id}/resources/{resource}/{namespace}/{name}/related", transport: "http", owner: "node", targetRelease: "2.0.6", migratedIn: "2.0.0-alpha.12", sourceModule: "routes_resources.py" },
  ...
  { method: "WS", path: "/clusters/{cluster_id}/pods/{namespace}/{name}/terminal", transport: "websocket", owner: "node", targetRelease: "2.0.6", migratedIn: "2.0.0-alpha.8", sourceModule: "routes_pods.py" },
  ...
  { method: "WS", path: "/clusters/{cluster_id}/resources/{resource}/watch-events", transport: "websocket", owner: "node", targetRelease: "2.0.6", migratedIn: "2.0.0-alpha.6", sourceModule: "routes_watch.py" },
