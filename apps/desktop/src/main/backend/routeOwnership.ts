...
export const ROUTE_OWNERSHIP: readonly RouteOwnership[] = [
  ...
  { method: "GET", path: "/resource-cache/status", transport: "http", owner: "node", targetRelease: "2.0.5", migratedIn: "2.0.0-alpha.5", sourceModule: "routes_core.py" },
  { method: "POST", path: "/resource-cache/clear", transport: "http", owner: "node", targetRelease: "2.0.5", migratedIn: "2.0.0-alpha.5", sourceModule: "routes_core.py" },
  ...
  { method: "GET", path: "/llm/status", transport: "http", owner: "node", targetRelease: "2.0.5", migratedIn: "2.0.0-alpha.13", sourceModule: "routes_llm.py" },
  { method: "POST", path: "/llm/test", transport: "http", owner: "node", targetRelease: "2.0.5", migratedIn: "2.0.0-alpha.13", sourceModule: "routes_llm.py" },
  { method: "POST", path: "/llm/preview-resource-prompt", transport: "http", owner: "node", targetRelease: "2.0.5", migratedIn: "2.0.0-alpha.13", sourceModule: "routes_llm.py" },
  { method: "POST", path: "/llm/analyze-resource", transport: "http", owner: "node", targetRelease: "2.0.5", migratedIn: "2.0.0-alpha.13", sourceModule: "routes_llm.py" },
  { method: "GET", path: "/clusters/{cluster_id}/problems", transport: "http", owner: "node", targetRelease: "2.0.5", migratedIn: "2.0.0-alpha.10", sourceModule: "routes_problems.py" },
  { method: "GET", path: "/clusters/{cluster_id}/search", transport: "http", owner: "node", targetRelease: "2.0.5", migratedIn: "2.0.0-alpha.11", sourceModule: "routes_search.py" },
  ...
  { method: "GET", path: "/clusters/{cluster_id}/deployments/{namespace}/{name}/log-targets", transport: "http", owner: "node", targetRelease: "2.0.5", migratedIn: "2.0.0-alpha.3.3", sourceModule: "routes_resources.py" },
  { method: "GET", path: "/clusters/{cluster_id}/deployments/{namespace}/{name}/logs", transport: "http", owner: "node", targetRelease: "2.0.5", migratedIn: "2.0.0-alpha.3.3", sourceModule: "routes_resources.py" },
  ...
  { method: "GET", path: "/clusters/{cluster_id}/resources/{resource}/{namespace}/{name}/related", transport: "http", owner: "node", targetRelease: "2.0.5", migratedIn: "2.0.0-alpha.12", sourceModule: "routes_resources.py" },
  ...
  { method: "WS", path: "/clusters/{cluster_id}/pods/{namespace}/{name}/terminal", transport: "websocket", owner: "node", targetRelease: "2.0.5", migratedIn: "2.0.0-alpha.8", sourceModule: "routes_pods.py" },
  { method: "GET", path: "/port-forwards", transport: "http", owner: "node", targetRelease: "2.0.5", migratedIn: "2.0.0-alpha.7", sourceModule: "routes_port_forward.py" },
  { method: "POST", path: "/clusters/{cluster_id}/port-forwards", transport: "http", owner: "node", targetRelease: "2.0.5", migratedIn: "2.0.0-alpha.7", sourceModule: "routes_port_forward.py" },
  { method: "DELETE", path: "/port-forwards/{session_id}", transport: "http", owner: "node", targetRelease: "2.0.5", migratedIn: "2.0.0-alpha.7", sourceModule: "routes_port_forward.py" },
  { method: "GET", path: "/watches/status", transport: "http", owner: "node", targetRelease: "2.0.5", migratedIn: "2.0.0-alpha.6", sourceModule: "routes_watch.py" },
  { method: "POST", path: "/clusters/{cluster_id}/watches", transport: "http", owner: "node", targetRelease: "2.0.5", migratedIn: "2.0.0-alpha.6", sourceModule: "routes_watch.py" },
  { method: "DELETE", path: "/watches/{watch_id}", transport: "http", owner: "node", targetRelease: "2.0.5", migratedIn: "2.0.0-alpha.6", sourceModule: "routes_watch.py" },
  { method: "POST", path: "/watches/stop-all", transport: "http", owner: "node", targetRelease: "2.0.5", migratedIn: "2.0.0-alpha.6", sourceModule: "routes_watch.py" },
  { method: "WS", path: "/clusters/{cluster_id}/resources/{resource}/watch-events", transport: "websocket", owner: "node", targetRelease: "2.0.5", migratedIn: "2.0.0-alpha.6", sourceModule: "routes_watch.py" },
  { method: "WS", path: "/clusters/{cluster_id}/nodes/{name}/ssh", transport: "websocket", owner: "node", targetRelease: "2.0.5", migratedIn: "2.0.0-alpha.9", sourceModule: "routes_node_ssh.py" },
];
