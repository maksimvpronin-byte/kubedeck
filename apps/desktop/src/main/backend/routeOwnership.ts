...
export const ROUTE_OWNERSHIP: readonly RouteOwnership[] = [
  ...
  { method: "GET", path: "/clusters", transport: "http", owner: "python", targetRelease: "2.0.0-alpha.2", sourceModule: "routes_clusters.py" },
  { method: "POST", path: "/clusters/import", transport: "http", owner: "python", targetRelease: "2.0.0-alpha.2", sourceModule: "routes_clusters.py" },
  { method: "PATCH", path: "/clusters/{cluster_id}", transport: "http", owner: "python", targetRelease: "2.0.0-alpha.2", sourceModule: "routes_clusters.py" },
  { method: "DELETE", path: "/clusters/{cluster_id}", transport: "http", owner: "python", targetRelease: "2.0.0-alpha.2", sourceModule: "routes_clusters.py" },
  ...
  { method: "POST", path: "/clusters/{cluster_id}/yaml/dry-run", transport: "http", owner: "python", targetRelease: "2.0.0-alpha.4", sourceModule: "routes_yaml.py" },
  { method: "PUT", path: "/clusters/{cluster_id}/yaml/apply", transport: "http", owner: "python", targetRelease: "2.0.0-alpha.4", sourceModule: "routes_yaml.py" },
  { method: "GET", path: "/clusters/{cluster_id}/resources/{resource}", transport: "http", owner: "python", targetRelease: "2.0.0-alpha.3", sourceModule: "routes_resources.py" },
  { method: "GET", path: "/clusters/{cluster_id}/secrets/{namespace}/{name}/keys", transport: "http", owner: "python", targetRelease: "2.0.0-alpha.4", sourceModule: "routes_resources.py" },
  { method: "POST", path: "/clusters/{cluster_id}/secrets/{namespace}/{name}/reveal", transport: "http", owner: "python", targetRelease: "2.0.0-alpha.4", sourceModule: "routes_resources.py" },
  { method: "POST", path: "/clusters/{cluster_id}/secrets/{namespace}/{name}/copy", transport: "http", owner: "python", targetRelease: "2.0.0-alpha.4", sourceModule: "routes_resources.py" },
  { method: "GET", path: "/clusters/{cluster_id}/deployments/{namespace}/{name}/log-targets", transport: "http", owner: "python", targetRelease: "2.0.0-beta.1", sourceModule: "routes_resources.py" },
  { method: "GET", path: "/clusters/{cluster_id}/deployments/{namespace}/{name}/logs", transport: "http", owner: "python", targetRelease: "2.0.0-beta.1", sourceModule: "routes_resources.py" },
  { method: "GET", path: "/clusters/{cluster_id}/resource-definitions", transport: "http", owner: "python", targetRelease: "2.0.0-alpha.3", sourceModule: "routes_resources.py" },
  { method: "GET", path: "/clusters/{cluster_id}/resources/{resource}/{namespace}/{name}/yaml", transport: "http", owner: "python", targetRelease: "2.0.0-alpha.3", sourceModule: "routes_resources.py" },
  { method: "GET", path: "/clusters/{cluster_id}/resources/{resource}/{namespace}/{name}/describe", transport: "http", owner: "python", targetRelease: "2.0.0-alpha.3", sourceModule: "routes_resources.py" },
  { method: "GET", path: "/clusters/{cluster_id}/resources/{resource}/{namespace}/{name}/events", transport: "http", owner: "python", targetRelease: "2.0.0-alpha.3", sourceModule: "routes_resources.py" },
  ...
  { method: "POST", path: "/clusters/{cluster_id}/resources/{resource}/{namespace}/{name}/action", transport: "http", owner: "python", targetRelease: "2.0.0-alpha.4", sourceModule: "routes_resources.py" },
  { method: "GET", path: "/clusters/{cluster_id}/pods/{namespace}/{name}/yaml", transport: "http", owner: "python", targetRelease: "2.0.0-alpha.3", sourceModule: "routes_pods.py" },
  { method: "GET", path: "/clusters/{cluster_id}/pods/{namespace}/{name}/describe", transport: "http", owner: "python", targetRelease: "2.0.0-alpha.3", sourceModule: "routes_pods.py" },
  { method: "GET", path: "/clusters/{cluster_id}/pods/{namespace}/{name}/logs", transport: "http", owner: "python", targetRelease: "2.0.0-alpha.3", sourceModule: "routes_pods.py" },
  { method: "POST", path: "/clusters/{cluster_id}/pods/{namespace}/{name}/exec", transport: "http", owner: "python", targetRelease: "2.0.0-alpha.4", sourceModule: "routes_pods.py" },
