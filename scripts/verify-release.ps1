...
<#
.SYNOPSIS
Validates KubeDeck 2.1.0 release-readiness invariants.
#>
...
$ReleaseNotes = Read-Text -Path (Join-Path $Root "RELEASE_NOTES_2.1.0.md")
$Checklist = Read-Text -Path (Join-Path $Root "REGRESSION_CHECKLIST_2.1.0.md")
