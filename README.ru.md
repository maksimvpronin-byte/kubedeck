...
```text
apps\desktop\release\KubeDeck-Portable-2.4.0-x64.exe
```
...
```text
apps/desktop/release/KubeDeck-2.4.0-arm64.dmg
apps/desktop/release/KubeDeck-2.4.0-arm64.zip
```
...
- [Release notes 2.4.0](./RELEASE_NOTES_2.4.0.md)
- [Regression checklist 2.4.0](./REGRESSION_CHECKLIST_2.4.0.md)
