...
```text
apps\desktop\release\KubeDeck-Setup-2.24.4-x64.exe
apps\desktop\release\KubeDeck-Portable-2.24.4-x64.exe
```
...
```text
apps/desktop/release/KubeDeck-2.24.4-arm64.dmg
apps/desktop/release/KubeDeck-2.24.4-arm64.zip
```
...
```text
apps/desktop/release/KubeDeck-2.24.4-x86_64.AppImage
```
...
- [Release notes 2.24.4](./docs/releases/RELEASE_NOTES_2.24.4.md)
- [Regression checklist 2.24.4](./docs/releases/REGRESSION_CHECKLIST_2.24.4.md)
