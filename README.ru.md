...
```text
apps\desktop\release\KubeDeck-Portable-2.20.5-x64.exe
```
...
```text
apps/desktop/release/KubeDeck-2.20.5-arm64.dmg
apps/desktop/release/KubeDeck-2.20.5-arm64.zip
```
...
```text
apps/desktop/release/KubeDeck-2.20.5-x86_64.AppImage
```
...
- [Release notes 2.20.5](./docs/releases/RELEASE_NOTES_2.20.5.md)
- [Regression checklist 2.20.5](./docs/releases/REGRESSION_CHECKLIST_2.20.5.md)
