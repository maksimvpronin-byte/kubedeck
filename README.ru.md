...
```text
apps\desktop\release\KubeDeck-Portable-2.16.1-x64.exe
```
...
```text
apps/desktop/release/KubeDeck-2.16.1-arm64.dmg
apps/desktop/release/KubeDeck-2.16.1-arm64.zip
```
...
```text
apps/desktop/release/KubeDeck-2.16.1-x86_64.AppImage
```
...
- [Release notes 2.16.1](./docs/releases/RELEASE_NOTES_2.16.1.md)
- [Regression checklist 2.16.1](./docs/releases/REGRESSION_CHECKLIST_2.16.1.md)
