...
Ветка: `main`
Текущая проверяемая версия: `2.4.3`
...
Исторические release notes и checklist 2.0.6 удалены после переноса итогов в `CHANGELOG.md`. Актуальные проверки находятся в `REGRESSION_CHECKLIST_2.4.3.md` и `docs/release-checklist.md`.

## Следующий этап

`2.4.3` сохраняет Node-only baseline, изолирует namespace-выбор по кластерам и атомарно переключает выбранный объект drawer без данных предыдущего ресурса.
