...
Ветка: `main`
Текущая проверяемая версия: `2.6.0`
...
Исторические release notes и checklist 2.0.6 удалены после переноса итогов в `CHANGELOG.md`. Актуальные проверки находятся в `REGRESSION_CHECKLIST_2.6.0.md` и `docs/release-checklist.md`.

## Следующий этап

`2.6.0` сохраняет Node-only baseline и добавляет закреплённую Pod Terminal-сессию, которая переживает навигацию по ресурсам без новых маршрутов или зависимостей.
