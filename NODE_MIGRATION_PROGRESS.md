...
Ветка: `main`
Текущая проверяемая версия: `2.3.1`
...
Исторические release notes и checklist 2.0.6 удалены после переноса итогов в `CHANGELOG.md`. Актуальные проверки находятся в `REGRESSION_CHECKLIST_2.3.1.md` и `docs/release-checklist.md`.

## Следующий этап

`2.3.1` сохраняет Node-only baseline и возможности 2.3.0, исправляет отображение длинных namespace-имён и обновляет тёмную палитру интерфейса.
