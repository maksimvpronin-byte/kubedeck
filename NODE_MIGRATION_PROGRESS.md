...
Ветка: `main`
Текущая проверяемая версия: `2.8.0`
...
Исторические release notes и checklist 2.0.6 удалены после переноса итогов в `CHANGELOG.md`. Актуальные проверки находятся в `docs/releases/REGRESSION_CHECKLIST_2.8.0.md` и `docs/release-checklist.md`.

## Следующий этап

`2.8.0` сохраняет Node-only baseline, унифицирует resource usage, добавляет безопасное YAML folding и локализует lazy loading без изменения Gateway ownership.
