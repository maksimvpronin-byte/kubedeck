...
Ветка: `main`
Текущая проверяемая версия: `2.4.5`
...
Исторические release notes и checklist 2.0.6 удалены после переноса итогов в `CHANGELOG.md`. Актуальные проверки находятся в `REGRESSION_CHECKLIST_2.4.5.md` и `docs/release-checklist.md`.

## Следующий этап

`2.4.5` сохраняет Node-only baseline и исправляет ошибки жизненного цикла runtime без добавления новых маршрутов или зависимостей.
