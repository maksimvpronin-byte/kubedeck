...
Ветка: `main`
Текущая проверяемая версия: `2.4.4`
...
Исторические release notes и checklist 2.0.6 удалены после переноса итогов в `CHANGELOG.md`. Актуальные проверки находятся в `REGRESSION_CHECKLIST_2.4.4.md` и `docs/release-checklist.md`.

## Следующий этап

`2.4.4` сохраняет Node-only baseline и устраняет двойную вставку в Pod Terminal на Windows за счёт единственного штатного пути ввода xterm.
