...
Ветка: `main`
Текущая проверяемая версия: `2.5.2`
...
Исторические release notes и checklist 2.0.6 удалены после переноса итогов в `CHANGELOG.md`. Актуальные проверки находятся в `REGRESSION_CHECKLIST_2.5.2.md` и `docs/release-checklist.md`.

## Следующий этап

`2.5.2` сохраняет Node-only baseline, расширяет размер страницы resource-таблицы до 2000 строк и упрощает замену выбранного namespace без новых маршрутов или зависимостей.
