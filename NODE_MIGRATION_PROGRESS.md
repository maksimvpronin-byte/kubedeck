...
Ветка: `main`
Текущая проверяемая версия: `2.5.0`
...
Исторические release notes и checklist 2.0.6 удалены после переноса итогов в `CHANGELOG.md`. Актуальные проверки находятся в `REGRESSION_CHECKLIST_2.5.0.md` и `docs/release-checklist.md`.

## Следующий этап

`2.5.0` сохраняет Node-only baseline и удаляет дважды проверенный неиспользуемый код без добавления новых маршрутов или зависимостей.
