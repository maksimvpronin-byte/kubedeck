...
Ветка: `main`
Текущая проверяемая версия: `2.5.1`
...
Исторические release notes и checklist 2.0.6 удалены после переноса итогов в `CHANGELOG.md`. Актуальные проверки находятся в `REGRESSION_CHECKLIST_2.5.1.md` и `docs/release-checklist.md`.

## Следующий этап

`2.5.1` сохраняет Node-only baseline, снижает повторную нагрузку resource watch и закрепляет заголовки больших таблиц без новых маршрутов или зависимостей.
