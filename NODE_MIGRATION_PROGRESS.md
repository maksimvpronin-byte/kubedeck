...
Ветка: `main`
Текущая проверяемая версия: `2.7.0`
...
Исторические release notes и checklist 2.0.6 удалены после переноса итогов в `CHANGELOG.md`. Актуальные проверки находятся в `REGRESSION_CHECKLIST_2.7.0.md` и `docs/release-checklist.md`.

## Следующий этап

`2.7.0` сохраняет Node-only baseline и добавляет вкладки ресурсов и несколько закреплённых Pod Terminal-сессий без новых маршрутов или зависимостей.
